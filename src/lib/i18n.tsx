...
const messages: Record<Locale, Messages> = {
  ...
  en: {
    ...
    browser_default_search: "Browser default",
    ...
    folder_hidden: 'Hidden folder "{title}"',
  ...
  ja: {
    ...
    browser_default_search: "ブラウザー既定",
    ...
    folder_hidden: "フォルダ「{title}」を非表示にしました",
